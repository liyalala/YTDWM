...
public class OutDlvPickFabFreeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outdlv_pickfabfree);

        prefs = PreferenceManager.getDefaultSharedPreferences(OutDlvPickFabFreeActivity.this.getApplicationContext());
        ...
        btConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*if ((new CheckNetwork(OutDlvPickFabFreeActivity.this)).isConnectingToInternet()) {
                    new PHPConfirmTO().execute();
                } else {
                    alrtLog = new AlertDialog.Builder(OutDlvPickFabFreeActivity.this).setMessage("Network Connection failed.")
        ...
        /*if ((new CheckNetwork(OutDlvPickFabFreeActivity.this)).isConnectingToInternet()) {
            ...
            alrtLog = new AlertDialog.Builder(OutDlvPickFabFreeActivity.this)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_delete) {
            if (!onDeleteMode) {
                if (PickList.size() == 0) {
                    alrtLog = new AlertDialog.Builder(OutDlvPickFabFreeActivity.this).setMessage("No Data Found.")
                            .setNegativeButton("Ok",
                                    new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            if (!prefs.getString("prefSession", "").equals("")) {
                try {
                    ...
                    if (minutes > sessionTime) { // show Login activity after 10mins of running in the background
                        ...
                        Intent intent = new Intent(OutDlvPickFabFreeActivity.this, LoginActivity.class);
    ...
    private class PHPOnload extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            dlDialog = ProgressDialog.show(OutDlvPickFabFreeActivity.this, "Please wait", "Checking data...");
        }
        ...
        protected void onPostExecute(String resString) {
            ...
            if (bError) {
                ...
                alrtLog = new AlertDialog.Builder(OutDlvPickFabFreeActivity.this).setMessage(strMsg)
                        .setNegativeButton("Ok",
                                new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (strAlertMsg.length() > 0) {
                    alrtLog = new AlertDialog.Builder(OutDlvPickFabFreeActivity.this).setMessage(strAlertMsg)
                            .setNegativeButton("Ok",
                                    new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialogInterface, int i) {
    ...
    private class PHPCheckScanItem extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            dlDialog = ProgressDialog.show(OutDlvPickFabFreeActivity.this, "Please wait", "Checking Scanned Item...");
        }
                ...
                if (resString != null) {
                    ...
                    try {
                        ...
                        if (!jsonResponse.getString("PickFree").equals("null")) {
                            ...
                            String DlvItem, BinCd, IntHUID, MatNo, Batch, ReqdQty, PickQty;
                            ...
                            for (int i = 0; i < jsonMainNode.length(); i++) {
                                ...
                                if (!onDeleteMode) {
                                    ...
                                    if (bContinue) {
                                        ...
                                        detail.setValues(DlvItem, BinCd, IntHUID, PickQty, "");
                                        subItems.add(detail);
                            ...
                            if (!bContinue) {
                                Toast.makeText(OutDlvPickFabFreeActivity.this, "Item already scanned.", Toast.LENGTH_LONG).show();
                                bContinue = true;
                            }
                        } else {
                        ...
                        pickingAdapter = new PickingFreeItemsAdapter(OutDlvPickFabFreeActivity.this, PickList);
                ...
                if (resString != null) {
                    ...
                    try {
                        ...
                        if (!jsonResponse.getString("confirmTO").equals("null")) {
                            ...
                            alrtLog = new AlertDialog.Builder(OutDlvPickFabFreeActivity.this).setMessage(Msg)
                                    .setNegativeButton("Ok",
                                            new DialogInterface.OnClickListener() {
                                                @Override
                                                public void onClick(DialogInterface dialogInterface, int i) {
