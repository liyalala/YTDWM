...
public class InbDlvPutAway1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prefs = PreferenceManager.getDefaultSharedPreferences(InbDlvPutAway1Activity.this.getApplicationContext());
        ...
        if (id == R.id.action_delete) {
            if (!onDeleteMode) {
                ...
                if (listBarcode.size() == 0) {
                    alrtLog = new AlertDialog.Builder(InbDlvPutAway1Activity.this).setMessage("No Data Found.")
                            .setNegativeButton("Ok",
                                    new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialogInterface, int i) {
    ...
    private void DoScan() {
        ...
        if (!onDeleteMode) {
            if ((strScanObj.equals("HU") || strScanObj.equals("HLHU")) && strBinCd.length() == 0) {
                alrtLog = new AlertDialog.Builder(InbDlvPutAway1Activity.this).setMessage("Bin is required.")
                        .setNegativeButton("Ok",
                                new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (strScanObj.equals("HU")) {
                    if (checkHUExists(listBarcode, strScanItem)) {
                        ...
                        Toast.makeText(InbDlvPutAway1Activity.this, "Item doesn't exists or already scanned.", Toast.LENGTH_LONG).show();
                } else {
                    new PHPCheckScanItem().execute();
                }
            }
            ...
            if (checkHUExists(listBarcode, strScanItem)) {
                ...
                Toast.makeText(InbDlvPutAway1Activity.this, "Item doesn't exists.", Toast.LENGTH_LONG).show();
        }
    }
    ...
    private class PHPOnloadPutAway extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            dlDialog = ProgressDialog.show(InbDlvPutAway1Activity.this, "Please wait", "Checking data...");
        }
        ...
        protected void onPostExecute(String resString) {
            ...
            if (bError) {
                ...
                if (strAlertMsg.length() > 0) {
                    alrtLog = new AlertDialog.Builder(InbDlvPutAway1Activity.this).setMessage(strAlertMsg)
                            .setNegativeButton("Ok",
                                    new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialogInterface, int i) {
    ...
    private class PHPCheckScanItem extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                URL url = new URL(GlobalVariables.gblURL + "CheckScanItemPutAway2.php");
                HttpURLConnection urlConnection = (HttpURLConnection) url.openConnection();
                try {
                    urlConnection.setRequestMethod("POST");
                    urlConnection.setConnectTimeout(GlobalVariables.gblTimeOut);
        ...
        protected void onPreExecute() {
            ...
            dlDialog = ProgressDialog.show(InbDlvPutAway1Activity.this, "Please wait", "Checking Scanned Item...");
        }
    ...
    private class PHPRemoveScanItem extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                URL url = new URL(GlobalVariables.gblURL + "RemoveScanItemPutAway1.php");
                HttpURLConnection urlConnection = (HttpURLConnection) url.openConnection();
                try {
                    urlConnection.setRequestMethod("POST");
                    urlConnection.setConnectTimeout(GlobalVariables.gblTimeOut);
    ...
    private class PHPConfirmTO extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            dlDialog = ProgressDialog.show(InbDlvPutAway1Activity.this, "Please wait", "Processing Data...");
        }
