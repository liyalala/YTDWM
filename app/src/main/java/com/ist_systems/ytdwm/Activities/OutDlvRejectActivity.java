...
public class OutDlvRejectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outdlv_reject);

        prefs = PreferenceManager.getDefaultSharedPreferences(OutDlvRejectActivity.this.getApplicationContext());

        String strTitle = getResources().getString(R.string.txtReject).concat(" for OD ").concat(GlobalVariables.gblDlvNo);
        setTitle(strTitle);
        ...
        btReject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (listBarcode.size() > 0) {
                    alrtLog = new AlertDialog.Builder(OutDlvRejectActivity.this).setMessage("Transfer to Reject? Please confirm.")
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_delete) {
            ...
            if (!onDeleteMode) {
                if (listBarcode.size() == 0) {
                    alrtLog = new AlertDialog.Builder(OutDlvRejectActivity.this).setMessage("No Data Found.")
            ...
            if (!prefs.getString("prefSession", "").equals("")) {
                try {
                    ...
                    if (minutes > sessionTime) { // show Login activity after 10mins of running in the background
                        ...
                        Intent intent = new Intent(OutDlvRejectActivity.this, LoginActivity.class);
    ...
    private void DoScan() {
        ...
        if (!onDeleteMode) {
            if ((strScanObj.equals("HUID") || strScanObj.equals("HLHUID")) && strDestBin.length() == 0) {
                alrtLog = new AlertDialog.Builder(OutDlvRejectActivity.this).setMessage("Bin is required.")
                        .setNegativeButton("Ok",
                                new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (strScanObj.equals("HUID")) {
                    if (checkHUExists(listBarcode, strScanItem)) {
                        Toast.makeText(OutDlvRejectActivity.this, "Item already scanned.", Toast.LENGTH_LONG).show();
                    } else {
            ...
            if (checkHUExists(listBarcode, strScanItem)) {
                ...
                Toast.makeText(OutDlvRejectActivity.this, "Item doesn't exists.", Toast.LENGTH_LONG).show();
        }
    }
    ...
    private class PHPCheckScanItem extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                URL url = new URL(GlobalVariables.gblURL + "CheckScanItemODReject.php");
        ...
        protected void onPreExecute() {
            ...
            dlDialog = ProgressDialog.show(OutDlvRejectActivity.this, "Please wait", "Checking Scanned Item...");
        }
        ...
        protected void onPostExecute(String resString) {
            ...
            if (bError) {
                ...
                alrtLog = new AlertDialog.Builder(OutDlvRejectActivity.this).setMessage(strMsg)
                        .setNegativeButton("Ok",
                                new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (strAlertMsg.length() > 0) {
                    alrtLog = new AlertDialog.Builder(OutDlvRejectActivity.this).setMessage(strAlertMsg)
                            .setNegativeButton("Ok",
                                    new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialogInterface, int i) {
    ...
    private class PHPDoStockTransfer extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                try {
                    ...
                    jObjectList.put("forReject", true);
        ...
        protected void onPreExecute() {
            ...
            dlDialog = ProgressDialog.show(OutDlvRejectActivity.this, "Please wait", "Processing...");
        }
