...
public class InbDlvRcvHUActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inbdlv_rcvhu);

        prefs = PreferenceManager.getDefaultSharedPreferences(InbDlvRcvHUActivity.this.getApplicationContext());
        ...
        btViewPending.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                InbDlvViewPendingHUFragment dialog = InbDlvViewPendingHUFragment.newInstance(GlobalVariables.gblDlvNo, "IDNo");
            ...
            public void onClick(View v) {
                ...
                if (iTotalHUScanned > 0) {
                    if (iTotalHUScanned < iTotPkg) {
                        alrtLog = new AlertDialog.Builder(InbDlvRcvHUActivity.this).setMessage("Not all items were scanned. Split Delivery?")
        ...
        if (id == R.id.action_delete) {
            ...
            if (!onDeleteMode) {
                if (listBarcode.size() == 0) {
                    alrtLog = new AlertDialog.Builder(InbDlvRcvHUActivity.this).setMessage("No Data Found.")
                            .setNegativeButton("Ok",
                                    new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialogInterface, int i) {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == 133 || keyCode == 135) {
            ...
            if ((!onDeleteMode) && Integer.toString(TotalHUScanned).equals(strTotNoPkgs)) {
                alrtLog = new AlertDialog.Builder(InbDlvRcvHUActivity.this).setMessage("All items are already scanned. Continue with Delivery Receive?")
                        .setPositiveButton("Yes",
                                new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialogInterface, int i) {
    ...
    private void DoScan() {
        ...
        if (!onDeleteMode) {
            if (!checkHUExists(listBarcode, strScanItem))
                ...
                Toast.makeText(InbDlvRcvHUActivity.this, "Item already scanned.", Toast.LENGTH_LONG).show();
        } else {
            if (checkHUExists(listBarcode, strScanItem)) {
                new PHPRemoveScanItem().execute();
                removeFromListView();
            } else
                Toast.makeText(InbDlvRcvHUActivity.this, "Item doesn't exists.", Toast.LENGTH_LONG).show();
        }
    ...
    private class PHPGetDetails extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                URL url = new URL(GlobalVariables.gblURL + "GetIDRcvHUDet.php");
                HttpURLConnection urlConnection = (HttpURLConnection) url.openConnection();
                try {
                    urlConnection.setRequestMethod("POST");
                    urlConnection.setConnectTimeout(GlobalVariables.gblTimeOut);
        ...
        protected void onPreExecute() {
            ...
            dlDialog = ProgressDialog.show(InbDlvRcvHUActivity.this, "Please wait", "Fetching Data...");
        }
                    ...
                    try {
                        ...
                        if (!jsonResponse.getString("CheckLock").equals("null")) {
                            ...
                            if (strLocked.equals("0")) {
                                String strAlertMsg = "Delivery " + GlobalVariables.gblDlvNo + " is currently locked by User " + strLockedBy + " in module " + strRemarks + ".";
                                alrtLog = new AlertDialog.Builder(InbDlvRcvHUActivity.this).setMessage(strAlertMsg)
                                        .setNegativeButton("Ok",
                                                new DialogInterface.OnClickListener() {
                                                    @Override
                                                    public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if (!jsonResponse.getString("IDRcvHU").equals("null")) {
                                    ...
                                    setTitle("ID " + GlobalVariables.gblDlvNo + " - " + strDlvStatus);
    ...
    private class PHPSetDlvRcvd extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                URL url = new URL(GlobalVariables.gblURL + "SetStatDlvRcvd1.php");
                HttpURLConnection urlConnection = (HttpURLConnection) url.openConnection();
                try {
                    urlConnection.setRequestMethod("POST");
                    urlConnection.setConnectTimeout(GlobalVariables.gblTimeOut);
        ...
        protected void onPreExecute() {
            ...
            dlDialog = ProgressDialog.show(InbDlvRcvHUActivity.this, "Please wait", "Processing Data...");
        }
        ...
        protected void onPostExecute(String resString) {
            ...
            if (bError) {
                    ...
                    try {
                        ...
                        if (!jsonResponse.getString("Result").equals("null")) {
                            ...
                            if (strResultCd.equals("0")) {
                                ...
                                setTitle("ID " + GlobalVariables.gblDlvNo + " - " + strDesc);
                ...
                if (strAlertMsg.length() > 0) {
                    alrtLog = new AlertDialog.Builder(InbDlvRcvHUActivity.this).setMessage(strAlertMsg + sMsgNewDlv)
                            .setNegativeButton("Ok",
                                    new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialogInterface, int i) {
    ...
    private class PHPCheckScanItem extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                URL url = new URL(GlobalVariables.gblURL + "CheckScanItem1.php");
                HttpURLConnection urlConnection = (HttpURLConnection) url.openConnection();
                try {
                    urlConnection.setRequestMethod("POST");
                    urlConnection.setConnectTimeout(GlobalVariables.gblTimeOut);
        ...
        protected void onPreExecute() {
            ...
            dlDialog = ProgressDialog.show(InbDlvRcvHUActivity.this, "Please wait", "Checking Scanned Item...");
        }
    ...
    private class PHPRemoveScanItem extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                URL url = new URL(GlobalVariables.gblURL + "RemoveScanItem.php");
                HttpURLConnection urlConnection = (HttpURLConnection) url.openConnection();
                try {
                    urlConnection.setRequestMethod("POST");
                    urlConnection.setConnectTimeout(GlobalVariables.gblTimeOut);
